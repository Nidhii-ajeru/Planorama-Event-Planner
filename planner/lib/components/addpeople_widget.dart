...
import 'addpeople_model.dart';
export 'addpeople_model.dart';
...
class _AddpeopleWidgetState extends State<AddpeopleWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddpeopleModel());
                ...
                children: [
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent('ADDPEOPLE_COMP_ADD_GUEST_BTN_ON_TAP');
                        logFirebaseEvent('Button_backend_call');

                        await GuestRecord.collection
                            .doc()
                            .set(createGuestRecordData(
                              guestName: _model.textController1.text,
                              guestPhone: _model.shortBioTextController.text,
                              userRefGuest: currentUserReference,
                            ));
                        ...
                        await showDialog(
                          ...
                          builder: (alertDialogContext) {
                            return AlertDialog(
                              ...
                              content: const Text('Your guest was added'),
                              actions: [
                                TextButton(
                                  onPressed: () =>
